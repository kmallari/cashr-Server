...
func newExpenseTableImpl(schemaName, tableName, alias string) expenseTable {
	var (
		...
		allColumns        = postgres.ColumnList{IDColumn, UserIDColumn, AmountColumn, DateColumn, CategoryColumn, DescriptionColumn, CreatedAtColumn}
		mutableColumns    = postgres.ColumnList{UserIDColumn, AmountColumn, DateColumn, CategoryColumn, DescriptionColumn, CreatedAtColumn}
	)
